    ...
    <div class="row">
        ...
        <div class="col-md-5">
          <a href="#">
            ...
            <h1 class="area-a">AREA<br>ANGGOTA</h1>
...
<div class="col-md-6" id="kanan-a">
    ...
    <div class="row h-100" id="kolomkanan">
        <div class="col-md-12">
                ...
                <form class="box area-a">
                    <h4>LOGIN ANGGOTA</h4>
                    <!-- <input type="text" name="" placeholder="ID Anggota"> <input type="password" name="" placeholder="Password"> <input type="submit" name="" value="Login" href="#"> -->
